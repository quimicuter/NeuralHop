...
const DASHBOARD_BACKGROUND = 'url("https://images.unsplash.com/photo-1551573355-19727699d60a?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")'
const PROJECT_IMAGE = 'https://images.unsplash.com/photo-1551573355-19727699d60a?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'

const WELLNESS_TABS = [
  { id: 'glow', label: 'Glow', description: 'Brillo y recuperación', accent: '255, 167, 102' },
  { id: 'vitality', label: 'Vitality', description: 'Energía y movimiento', accent: '118, 97, 255' },
  { id: 'innerBalance', label: 'Inner Balance', description: 'Hidratación y digestión', accent: '75, 190, 165' },
  { id: 'zenRest', label: 'Zen Rest', description: 'Sueño profundo y calma', accent: '113, 130, 255' }
]
