    ...
    <div className="hub-overlay">
      <div className="hub-container">
        <div className="hub-header">
          <h2 className="hub-title">💻 Tecno Girl Hub</h2>
          <button className="close-btn" onClick={onClose}>×</button>
        </div>
        
        <div className="hub-content">
          {/* Clases - 2x1 */}
          <div className="hub-panel classes-card">
            <h3 className="hub-subtitle">📅 Clases</h3>
          ...
          {/* Proyectos - 2x1 */}
          <div className="hub-panel projects-card">
            <h3 className="hub-subtitle">🎯 Proyectos</h3>
          ...
          {/* Plataformas - 1x2 */}
          <div className="hub-panel platforms-card">
            <h3 className="hub-subtitle">🔗 Plataformas</h3>
          ...
          {/* Progreso - 1x1 */}
          <div className="hub-panel progress-card">
            <h3 className="hub-subtitle">📈 Progreso</h3>
          ...
          {/* Tareas - 1x1 */}
          <div className="hub-panel tasks-summary-card">
            <h3 className="hub-subtitle">📝 Tareas</h3>
          ...
          <div className="hub-panel activities-card">
            <div className="activities-header">
              <h3 className="hub-subtitle">📋 Actividades</h3>
